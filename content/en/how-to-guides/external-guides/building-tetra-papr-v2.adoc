...
This guide will walk you through how to build a Personal Air Purifying Respirator, also known as a PAPR.  It assumes that you have some knowledge of 3D-printing, and cutting foam with a knife using a stencil, or that you're willing to learn, as the steps are fairly basic.  In the end, you will have three things: a box with a filter and a fan in it, a second box with batteries and a fan controller, and a mask.  These three things will be connected by hoses, wires, and straps, and you'll have something that will comfortably protect you from contiminated air.
...
.Table Printed Parts
|===
| Part | Quantity | Material | STL File Location
...
| The outer fan control board protector
| 1 
| PLA
...
| The inner fan control board protector
| 1 
| PLA
...
The files used in this build are v 2.0; later versions will require updates to this documentation.  You can download all files together here: https://github.com/tetrabiodistributed/papr-print-files/releases/tag/1.0
